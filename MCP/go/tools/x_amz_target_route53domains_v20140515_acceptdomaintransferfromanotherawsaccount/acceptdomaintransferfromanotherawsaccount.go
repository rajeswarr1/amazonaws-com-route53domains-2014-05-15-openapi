...
func AcceptdomaintransferfromanotherawsaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AcceptDomainTransferFromAnotherAwsAccountRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount", cfg.BaseURL)
		...
		var result models.AcceptDomainTransferFromAnotherAwsAccountResponse
...
func CreateAcceptdomaintransferfromanotherawsaccountTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    AcceptdomaintransferfromanotherawsaccountHandler(cfg),
	}
}
