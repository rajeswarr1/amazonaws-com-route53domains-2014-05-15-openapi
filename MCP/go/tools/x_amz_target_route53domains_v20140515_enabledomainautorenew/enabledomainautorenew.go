...
func EnabledomainautorenewHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.EnableDomainAutoRenewRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Domains_v20140515.EnableDomainAutoRenew", cfg.BaseURL)
		...
		var result models.EnableDomainAutoRenewResponse
...
func CreateEnabledomainautorenewTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    EnabledomainautorenewHandler(cfg),
	}
}
