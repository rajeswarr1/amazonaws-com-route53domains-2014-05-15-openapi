...
func RejectdomaintransferfromanotherawsaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RejectDomainTransferFromAnotherAwsAccountRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Domains_v20140515.RejectDomainTransferFromAnotherAwsAccount", cfg.BaseURL)
		...
		var result models.RejectDomainTransferFromAnotherAwsAccountResponse
...
func CreateRejectdomaintransferfromanotherawsaccountTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    RejectdomaintransferfromanotherawsaccountHandler(cfg),
	}
}
