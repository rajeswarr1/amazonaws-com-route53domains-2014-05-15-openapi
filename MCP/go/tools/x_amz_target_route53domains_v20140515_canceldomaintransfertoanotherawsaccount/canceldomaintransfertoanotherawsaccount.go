...
func CanceldomaintransfertoanotherawsaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CancelDomainTransferToAnotherAwsAccountRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Domains_v20140515.CancelDomainTransferToAnotherAwsAccount", cfg.BaseURL)
		...
		var result models.CancelDomainTransferToAnotherAwsAccountResponse
...
func CreateCanceldomaintransfertoanotherawsaccountTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CanceldomaintransfertoanotherawsaccountHandler(cfg),
	}
}
