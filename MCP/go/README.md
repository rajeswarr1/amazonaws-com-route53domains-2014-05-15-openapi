# Amazon Route 53 Domains MCP Server

This MCP (Model Content Protocol) server provides access to Amazon Route 53 Domains API functionality through HTTP, HTTPS, and STDIO transport modes.
